  ...
  return (
    <>
      <TableCell align="center" sx={{ width: '100px' }} onClick={() => setPairIndex(pairIndex)}>
        <Benefit
          value={priceChange === 'Loading...' ? 'Loading...' : (priceChange as any).priceChange.toPrecision(4)}
          percent={priceChange === 'Loading...' ? 'Loading...' : (priceChange as any).priceChangePercent.toFixed(2)}
        />
      </TableCell>
    </>
  );
